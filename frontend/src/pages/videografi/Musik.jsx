import { Music, CheckCircle, ArrowRight, Video, Mic, Headphones, TrendingUp } from "lucide-react";
...
function Musik() {
  return (
    <div className="min-h-screen bg-white">
      <Navbar activePage="/videografi/musik" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Musik video profesional untuk artis dan band dengan konsep kreatif, sinematik, dan kualitas tinggi.
              </p>
              <Link
                to="/#contact"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Cinematic Production</h3>
              <p className="text-gray-600">
                Produksi sinematik dengan equipment profesional.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              <div className="w-14 h-14 bg-primary-100 rounded-lg flex items-center justify-center mb-4">
                <Mic className="text-primary-600" size={28} />
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Live Performance</h3>
              <p className="text-gray-600">
                Dokumentasi live performance dan konser.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              <div className="w-14 h-14 bg-primary-100 rounded-lg flex items-center justify-center mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Audio Sync</h3>
              <p className="text-gray-600">
                Sinkronisasi audio yang presisi dengan video.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              <div className="w-14 h-14 bg-primary-100 rounded-lg flex items-center justify-center mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">VFX & Effects</h3>
              <p className="text-gray-600">
                Visual effects dan editing yang kreatif.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              <div className="w-14 h-14 bg-primary-100 rounded-lg flex items-center justify-center mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Concept Development</h3>
              <p className="text-gray-600">
                Pengembangan konsep dan storyboard kreatif.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              <div className="w-14 h-14 bg-primary-100 rounded-lg flex items-center justify-center mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Color Grading</h3>
              <p className="text-gray-600">
                Color grading profesional untuk estetika visual.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-primary-600 to-primary-800 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold mb-6">
            Siap Membuat Video Musik Profesional?
          </h2>
