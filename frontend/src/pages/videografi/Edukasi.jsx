import { GraduationCap, CheckCircle, ArrowRight, Video, BookOpen, Users, FileText } from "lucide-react";
...
function Edukasi() {
  return (
    <div className="min-h-screen bg-white">
      <Navbar activePage="/videografi/edukasi" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 mb-6">
                Video Edukasi
                <span className="text-primary-600"> Pembelajaran</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8">
                Video tutorial dan materi pembelajaran untuk institusi edukasi dengan kualitas tinggi dan engaging.
              </p>
              <Link
                to="/#contact"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Tutorial Videos</h3>
              <p className="text-gray-600">
                Video tutorial step-by-step untuk pembelajaran mudah.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              <div className="w-14 h-14 bg-primary-100 rounded-lg flex items-center justify-center mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Lecture Recording</h3>
              <p className="text-gray-600">
                Rekam kuliah dan seminar untuk arsip edukasi.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              <div className="w-14 h-14 bg-primary-100 rounded-lg flex items-center justify-center mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Animated Graphics</h3>
              <p className="text-gray-600">
                Animasi dan graphics untuk visualisasi konsep.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              <div className="w-14 h-14 bg-primary-100 rounded-lg flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600">
                Screen recording untuk tutorial software dan aplikasi.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              <div className="w-14 h-14 bg-primary-100 rounded-lg flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600">
                Subtitle dan dubbing dalam berbagai bahasa.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              <div className="w-14 h-14 bg-primary-100 rounded-lg flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600">
                Quiz dan elemen interaktif dalam video pembelajaran.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-center mb-4 text-gray-900">
            Paket Harga Video Edukasi
          </h2>
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            Pilih paket yang sesuai dengan kebutuhan edukasi Anda
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Basic</h3>
              <p className="text-gray-600 mb-6">Untuk tutorial sederhana</p>
              <div className="mb-6">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">5-10 Menit Durasi</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="text-green-500 mr-2 mt-1" size={16} />
            ...
            <div className="bg-primary-600 p-8 rounded-2xl shadow-xl border-2 border-primary-500 relative">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-start">
                  ...
                  <span className="text-white">15-30 Menit Durasi</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="text-yellow-400 mr-2 mt-1" size={16} />
