import { Heart, CheckCircle, ArrowRight, Calendar, Stethoscope, Video, Pill } from "lucide-react";
...
function Kesehatan() {
  return (
    <div className="min-h-screen bg-white">
      <Navbar activePage="/aplikasi/kesehatan" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Aplikasi medis untuk booking, telemedicine, dan manajemen kesehatan dengan fitur lengkap dan aman.
              </p>
              <Link
                to="/#contact"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              ...
              <p className="text-gray-600">
                Booking online dengan dokter dan spesialis.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              <div className="w-14 h-14 bg-primary-100 rounded-lg flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600">
                Konsultasi online via video call dengan dokter.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              <div className="w-14 h-14 bg-primary-100 rounded-lg flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600">
                Akses riwayat medis dan hasil lab secara digital.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              <div className="w-14 h-14 bg-primary-100 rounded-lg flex items-center justify-center mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Pengingat Obat</h3>
              <p className="text-gray-600">
                Notifikasi pengingat jadwal minum obat.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              <div className="w-14 h-14 bg-primary-100 rounded-lg flex items-center justify-center mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Chat Dokter</h3>
              <p className="text-gray-600">
                Chat langsung dengan dokter untuk konsultasi cepat.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              <div className="w-14 h-14 bg-primary-100 rounded-lg flex items-center justify-center mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Artikel Kesehatan</h3>
              <p className="text-gray-600">
                Artikel edukasi kesehatan terkini dan tips.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-center mb-4 text-gray-900">
            Paket Harga Aplikasi Kesehatan
          </h2>
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            Pilih paket yang sesuai dengan kebutuhan aplikasi kesehatan Anda
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
              ...
              <div className="mb-6">
                <span className="text-4xl font-extrabold text-gray-900">Rp 12.000.000</span>
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-start">
                  <CheckCircle className="text-green-500 mr-2 mt-1" size={16} />
                  <span className="text-gray-700">Booking Basic</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="text-green-500 mr-2 mt-1" size={16} />
            ...
            <div className="bg-primary-600 p-8 rounded-2xl shadow-xl border-2 border-primary-500 relative">
              ...
              <div className="mb-6">
                <span className="text-4xl font-extrabold text-white">Rp 30.000.000</span>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
              ...
              <div className="mb-6">
                <span className="text-4xl font-extrabold text-gray-900">Rp 60.000.000</span>
                <span className="text-gray-600">/project</span>
              </div>
              <ul className="space-y-3 mb-8">
                <li className="flex items-start">
                ...
                <li className="flex items-start">
                  <CheckCircle className="text-green-500 mr-2 mt-1" size={16} />
                  <span className="text-gray-700">EMR Integration</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="text-green-500 mr-2 mt-1" size={16} />
                  <span className="text-gray-700">AI Diagnostics</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="text-green-500 mr-2 mt-1" size={16} />
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-primary-600 to-primary-800 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold mb-6">
            Siap Membangun Aplikasi Kesehatan?
          </h2>
