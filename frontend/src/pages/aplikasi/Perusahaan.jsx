import { Building, CheckCircle, ArrowRight, Users, Briefcase, BarChart, FileText } from "lucide-react";
...
function Perusahaan() {
  return (
    <div className="min-h-screen bg-white">
      <Navbar activePage="/aplikasi/perusahaan" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 mb-6">
                Aplikasi Perusahaan
                <span className="text-primary-600"> Bisnis</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8">
                Sistem manajemen bisnis dan produktivitas untuk perusahaan dengan fitur lengkap dan terintegrasi.
              </p>
              <Link
                to="/#contact"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Manajemen Karyawan</h3>
              <p className="text-gray-600">
                Database karyawan dengan absensi dan performa.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              <div className="w-14 h-14 bg-primary-100 rounded-lg flex items-center justify-center mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Manajemen Proyek</h3>
              <p className="text-gray-600">
                Tracking proyek dengan timeline dan tugas.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              <div className="w-14 h-14 bg-primary-100 rounded-lg flex items-center justify-center mb-4">
                <BarChart className="text-primary-600" size={28} />
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Analytics & Laporan</h3>
              <p className="text-gray-600">
                Dashboard analitik dan laporan bisnis lengkap.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              <div className="w-14 h-14 bg-primary-100 rounded-lg flex items-center justify-center mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Dokumen Digital</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Chat Internal</h3>
              <p className="text-gray-600">
                Komunikasi tim dengan chat dan grup.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              <div className="w-14 h-14 bg-primary-100 rounded-lg flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600">
                Manajemen stok dan aset perusahaan.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-center mb-4 text-gray-900">
            Paket Harga Aplikasi Perusahaan
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">Single Platform (Android)</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="text-green-500 mr-2 mt-1" size={16} />
                  <span className="text-gray-700">10 Screens</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="text-green-500 mr-2 mt-1" size={16} />
                  <span className="text-gray-700">Manajemen Karyawan</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="text-green-500 mr-2 mt-1" size={16} />
            ...
            <div className="bg-primary-600 p-8 rounded-2xl shadow-xl border-2 border-primary-500 relative">
              ...
              <div className="mb-6">
                <span className="text-4xl font-extrabold text-white">Rp 25.000.000</span>
                <span className="text-primary-100">/project</span>
              </div>
              <ul className="space-y-3 mb-8">
                <li className="flex items-start">
                  <CheckCircle className="text-yellow-400 mr-2 mt-1" size={16} />
                  <span className="text-white">Cross-platform (Android + iOS)</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="text-yellow-400 mr-2 mt-1" size={16} />
                  <span className="text-white">20 Screens</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="text-yellow-400 mr-2 mt-1" size={16} />
                  <span className="text-white">Manajemen Proyek</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="text-yellow-400 mr-2 mt-1" size={16} />
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
              ...
              <div className="mb-6">
                <span className="text-4xl font-extrabold text-gray-900">Rp 50.000.000</span>
                <span className="text-gray-600">/project</span>
              </div>
              <ul className="space-y-3 mb-8">
                <li className="flex items-start">
                  <CheckCircle className="text-green-500 mr-2 mt-1" size={16} />
                  <span className="text-gray-700">Multi-platform + Web</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="text-green-500 mr-2 mt-1" size={16} />
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-primary-600 to-primary-800 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold mb-6">
            Siap Membangun Aplikasi Perusahaan?
          </h2>
