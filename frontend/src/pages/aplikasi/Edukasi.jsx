import { GraduationCap, CheckCircle, ArrowRight, BookOpen, Video, Trophy, Users } from "lucide-react";
...
function Edukasi() {
  return (
    <div className="min-h-screen bg-white">
      <Navbar activePage="/aplikasi/edukasi" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Platform pembelajaran online dengan fitur kuis, materi interaktif, dan sertifikat untuk institusi edukasi.
              </p>
              <Link
                to="/#contact"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Kursus Interaktif</h3>
              <p className="text-gray-600">
                Materi pembelajaran dengan video dan interaksi.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              <div className="w-14 h-14 bg-primary-100 rounded-lg flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600">
                Platform video streaming untuk materi pembelajaran.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              <div className="w-14 h-14 bg-primary-100 rounded-lg flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600">
                Kuis interaktif dengan auto-grading dan leaderboard.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
              <div className="w-14 h-14 bg-primary-100 rounded-lg flex items-center justify-center mb-4">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-primary-600 p-8 rounded-2xl shadow-xl border-2 border-primary-500 relative">
              ...
              <div className="mb-6">
                <span className="text-4xl font-extrabold text-white">Rp 20.000.000</span>
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-start">
                  <CheckCircle className="text-yellow-400 mr-2 mt-1" size={16} />
                  <span className="text-white">Forum & Kuis</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="text-yellow-400 mr-2 mt-1" size={16} />
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
              ...
              <div className="mb-6">
                <span className="text-4xl font-extrabold text-gray-900">Rp 40.000.000</span>
                <span className="text-gray-600">/project</span>
              </div>
              <ul className="space-y-3 mb-8">
                <li className="flex items-start">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-primary-600 to-primary-800 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold mb-6">
            Siap Membangun Aplikasi Edukasi?
          </h2>
